...
listen_PORT = 10001  # pyprox listening to 127.0.0.1:listen_PORT

Cloudflare_IP = '185.70.196.100'  # plos.org (can be any dirty cloudflare ip)
Cloudflare_port = 443

L_fragment = 88  # length of fragments of Client Hello packet (L_fragment Byte in each chunk)
...
class ThreadedServer(object):
    ...
    def listen(self):
        self.sock.listen(
            128)  # up to 128 concurrent unaccepted socket queued , the more is refused untill accepting those.
        while True:
